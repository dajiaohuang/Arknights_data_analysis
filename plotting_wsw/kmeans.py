...
data = df.loc[:, 'hp1':'defence2'].copy()

x = data.to_numpy()
x=x.transpose()
x=np.array([x[0],x[2],x[4]])
x=x.transpose()
print(x)
...
————————————————
版权声明：本文为CSDN博主「苏格拉没有鞋底」的原创文章，遵循CC 4.0 BY-SA版权协议，转载请附上原文出处链接及本声明。
原文链接：https://blog.csdn.net/sgld995/article/details/108390774