...
header = {'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36 Edg/119.0.0.0'}
...
nextUrls = originalHTML.xpath('//div[@class="akIll"]/span[@class="akIllLayer7"]/a/@h')
...
for j in nextUrls:
    ...
    name = nextHTML.xpath('//*[@id="mw-content-text"]/div/div[6]/div/table/tbody/tr[3]/td')
